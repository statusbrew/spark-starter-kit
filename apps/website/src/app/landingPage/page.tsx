  ...
  return (
    <>
      <div className="w-full text-center flex flex-col justify-center items-center bg-[url('/homeBg.png')] bg-cover relative">
        ...
        <div className="flex flex-wrap justify-between items-center px-6 md:gap-24 md:w-11/12 my-8 bg-white rounded-2xl">
          ...
          <div className="flex sm:gap-5 md:gap-8 md:pl-8 h-full w-auto py-auto items-center justify-center">
            <a href="/" className="text-gray-600 font-semibold hover:text-gray-900 cursor-pointer">
              HOME
            </a>
            <a href="#about" className="text-gray-600 font-semibold hover:text-gray-900 cursor-pointer">
              ABOUT US
            </a>
            <a href="#solution" className="text-gray-600 font-semibold hover:text-gray-900 cursor-pointer">
              SOLUTION
            </a>
            <a href="#contact" className="text-gray-600 font-semibold hover:text-gray-900 cursor-pointer">
              CONTACT US
            </a>
          </div>
        ...
        <div className="flex flex-col w-11/12">
          <div className="text-4xl font-semibold">Effortless Parking, Every Time.</div>
        ...
        <div className="pt-8 flex justify-center items-center">
          <button className="bg-black flex justify-center items-center gap-2 text-white rounded-lg p-2 px-4 mr-5">
            <PiStarFourThin /> Get Started
          </button>
        </div>
        <img src="/image.png" alt="image" className="w-[400px] h-[600px] ml-16" />

        {/* team */}
        <h1 id="about" className="font-semibold text-3xl my-4">
          Our Team
        </h1>
      ...
      <section id="solution" className="w-full flex flex-col lg:flex-row justify-between relative items-center">
        ...
        <div className="w-full md:w-[60%] flex flex-col justify-center items-center gap-[2rem] p-6">
          ...
          <ul className="text-base md:text-xl list-disc flex flex-col justify-start items-center gap-4 ml-4">
            <li>
              No more endless circling for a parking spot. Our system{" "}
              <span className="bg-[#d9f812a5]">automatically assigns</span> you a parking space upon your
              arrival.
            </li>
            <li>
              Get instant guidance to your assigned parking spot with{" "}
              <span className="bg-[#d9f812a5]">real-time navigation,</span> eliminating confusion and saving
              time.
            </li>
            <li>
              Enjoy a hassle-free parking experience with{" "}
              <span className="bg-[#d9f812a5]">upfront payment</span> options, ensuring a smooth entry and exit
              process.
            </li>
            <li>
              If assigned spot is occupied, don't worry. Our system will immediately{" "}
              <span className="bg-[#d9f812a5]">reassign</span> you the nearest available spot.
            </li>
            <li>
              Gain <span className="bg-[#d9f812a5]">valuable analytics</span> on parking usage and patterns,
              allowing for informed decision-making and optimized space management.
            </li>
          </ul>
        </div>
      ...
      <section id="contact" className="w-full bg-black p-[1rem] text-center gap-6 md:p-[3rem] overflow-hidden relative flex flex-col justify-center items-center">
        ...
        <p className="text-sm text-white mb-8 md:mb-[4rem]">
        ...
        <div className="w-full md:w-11/12 lg:w-8/12 flex flex-col lg:flex-row">
          <img
            ...
            alt="Laptop"
            loading="lazy"
            className="w-full lg:w-[50%] rounded-tl-xl rounded-tr-xl md:rounded-tr-none md:rounded-bl-xl"
          />
          ...
          <form onSubmit={submitHandler} className="w-full bg-white max-w-4xl rounded-bl-xl rounded-br-xl md:rounded-bl-none md:rounded-tr-xl mx-auto p-1">
            <div className="flex flex-wrap gap-6 p-2 lg:gap-8 mb-4 lg:p-[2rem] justify-between item-start">
              <div className="flex flex-wrap justify-between gap-4 w-full">
                ...
                <label className="w-full sm:w-[45%]">
                  <p className="my-2 text-start">
                    Mobile Number <sup className="text-red-400">*</sup>
                  </p>
                  <input
                    required
                    className="text-[0.9rem] border-2 rounded-lg p-2 w-full py-2 outline-none"
                ...
                <label className="w-full sm:w-[45%]">
                  <p className="my-2 text-start">
                    Complex Name <sup className="text-red-400">*</sup>
                  </p>
                  <input
                    required
                    className="text-[0.9rem] border-2 rounded-lg p-2 w-full py-2 outline-none"
      ...
      <footer className="w-full flex flex-col bg-black text-white py-[2rem] px-[4rem]">
        ...
        <div className="flex justify-between items-start border-b-[1px] pb-12 pt-3 border-gray-400">
          ...
          <div className="flex flex-col text-lg justify-start items-start w-[15%] gap-2">
            ...
            <h2>For Shopping Malls</h2>
            <h2>For Parking Complexes</h2>
          </div>
          <div className="flex flex-col text-lg justify-start items-start w-[15%] gap-2">
