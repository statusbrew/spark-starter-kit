    ...
    return (
        <>
            <div className="w-full text-center flex flex-col justify-center items-center bg-[url('/homeBg.png')] bg-cover relative">
                ...
                <div className="flex justify-between px-6 md:gap-24 md:w-11/12 my-8 bg-white h-16 rounded-2xl">
                    ...
                    <div className=" sm:pl-8 font-semibold flex self-center md:gap-3 sm:gap-2">
                        <button className="  font-semibold bg-white text-black border border-black rounded-lg p-2 w-20 hover:bg-black duration-500 hover:text-white">Login</button>
                        <button className=" font-semibold bg-black  text-white rounded-lg p-2 w-20 hover:bg-gray-800 hover:border hover:border-black">Sign Up</button>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between gap-8 w-8/12 my-10 mb-[5rem]">
                    {
                        team.map((item, index) => (
            ...
            <section className="w-full bg-black p-[1rem] text-center gap-6 md:p-[3rem] overflow-hidden relative flex flex-col justify-center items-center">
                ...
                <div className="w-full md:w-11/12 lg:w-8/12 flex flex-col md:flex-row">
                    <div className="w-full bg-white md:w-[45%] min-h-[400px] rounded-tl-xl rounded-tr-xl md:rounded-tr-none md:rounded-bl-xl h-full flex justify-center items-center relative overflow-hidden">
                        <img src="/parking.svg" alt="Laptop" loading="lazy" className="absolute inset-0 w-[100%] h-[100%] object-cover" />
                    </div>
