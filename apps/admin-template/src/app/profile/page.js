...
//     try {
//       const parkingFeeResponse = await fetch(`${apiUrl}/admin/register/mallDetails`, {
//         method: "POST",
//         headers: {
...
//       if (!parkingFeeResponse.ok) throw new Error("Error submitting parking fee");
      
//       setSuccessMessage("Parking fee submitted successfully!");
//       setErrorMessage("");
//     } catch (error) {
...
//     try {
//       const parkingLayoutResponse = await fetch(`${apiUrl}/admin/register/parkingLayout`, {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//           Authorization: authToken,
//         },
//         body: JSON.stringify({
//           numberOfPillars: formData.numberOfPillars,
//           pillars: formData.pillars,
//           minCarsPerPillar: formData.minCarsPerPillar,
//           entryGateNearestPillar: formData.entryGateNearestPillar,
//           exitGateNearestPillar: formData.exitGateNearestPillar,
//         }),
//       });

//       if (!parkingLayoutResponse.ok) throw new Error("Error submitting parking layout");
      
//       setSuccessMessage("Parking layout submitted successfully!");
//       setErrorMessage("");
//     } catch (error) {
//       console.error("Error:", error);
...
//     try {
//       const mallDetailsResponse = await fetch(`${apiUrl}/admin/register/parkingFee`, {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//           Authorization: authToken,
//         },
//         body: JSON.stringify({
//           complexNameName: formData.complexNameName,
//           email: formData.email,
//           mallLocation: formData.mallLocation,
//           contactSupport: formData.contactSupport,
//         }),
//       });

//       if (!mallDetailsResponse.ok) throw new Error("Error submitting mall details");
      
//       setSuccessMessage("Mall details submitted successfully!");
//       setErrorMessage("");
//     } catch (error) {
//       console.error("Error:", error);
...
//                 <form onSubmit={(e) => submitMallDetails(e, 'mall')} className="w-[40%] bg-white z-10 max-w-4xl rounded-xl mx-auto">
//                     <div className="flex flex-wrap gap-6 p-2 lg:gap-4 mb-4 lg:p-[2rem] justify-between item-start">
//                         {/* Input Fields */}
//                         {['complexName', 'email', 'mallLocation', 'contactSupport', 'operatingHours'].map((field) => (
...
//                 <form onSubmit={(e) => submitParkingLayout(e, 'parking')} className="w-[40%] z-10 bg-white max-w-4xl rounded-xl mx-auto">
//                     <div className="flex flex-wrap gap-6 p-2 lg:gap-4 mb-4 lg:p-[2rem] justify-between item-start">
...
//                 <form onSubmit={(e) => submitParkingFee(e, 'payment')} className="w-[40%] z-10 bg-white max-w-4xl rounded-xl mx-auto">
//                     <div className="flex flex-wrap gap-6 p-2 lg:gap-4 mb-4 lg:p-[2rem] justify-between item-start">
